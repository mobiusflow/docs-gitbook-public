...
<figure><img src="../../.gitbook/assets/image.png" alt=""><figcaption><p>Example of how to use a getResource node</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (1).png" alt=""><figcaption><p>Configuration window of the getResource node</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (2).png" alt=""><figcaption><p>Node label of the getResource node reflecting the specified resource URI</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (3).png" alt=""><figcaption><p>Debug window showing the result of the triggered flow. In this case the current value of specified resource was 0</p></figcaption></figure>

The getObject node works in an identical way however an object URI is specified instead of a resource URI.

<figure><img src="../../.gitbook/assets/image (4).png" alt=""><figcaption><p>Result of equivalent flow when using getObject node</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (5).png" alt=""><figcaption><p>Example flow of a resourceCov node</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (7).png" alt=""><figcaption><p>Example flow of the objectCov node</p></figcaption></figure>
...
{% hint style="info" %}
The getResource, getObject, resourceCov and objectCov nodes can also make use or [URI wildcarding](../../user-guides/mobiusflow-r/mobiusflow-uniform-resource-identifiers.md#mobiusflowuniformresourceidentifiers-mobiusuriwildcards), allowing for a group of objects or resources to be selected instead of a just one.
...
<figure><img src="../../.gitbook/assets/image (8).png" alt=""><figcaption><p>Example usage of second output</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (9).png" alt=""><figcaption><p>ResourceCov node with 'Use detailed outputs' enabled</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (10).png" alt=""><figcaption><p>Example of usage of all detailed outputs</p></figcaption></figure>
...
<table><thead><tr><th width="166.33333333333331">Node Type</th><th width="96">Type</th><th>Explanation</th></tr></thead><tbody><tr><td>Mobius Flow Inject</td><td>COV</td><td>Allows the definition of a set included or exluded URIs (including <a href="../../user-guides/mobiusflow-r/mobiusflow-uniform-resource-identifiers.md#mobiusflowuniformresourceidentifiers-mobiusuriwildcards">wildcards</a>). The node will act similar to an objectCov node for all of these included (but not excluded) URIs and output their data into your flow in the MobiusFlow Inject standard format. Nodei s very useful when linked with a Cloud Format node to allow data to be send to cloud application.</td></tr><tr><td>Get Multi-Object</td><td>Get</td><td>Get several objects in a single message when triggered based on a pre-specified set of URIs (including <a href="../../user-guides/mobiusflow-r/mobiusflow-uniform-resource-identifiers.md#mobiusflowuniformresourceidentifiers-mobiusuriwildcards">wildcards</a>).</td></tr><tr><td>Filter by Rid Value</td><td>Get</td><td>Allows a set of objects to be specified as well as a single resource. When triggered, the node will test the specified resource of all objects against a user defined filtration function and will output a list of all objects which passed the filter.</td></tr><tr><td>Discover</td><td>Get</td><td>Allows a the discovery of MobiusFlow entities based on a URI specified within the input topic. The discovery will work on any level (service / profile / object / etc. ) based on how specified the input URI is.</td></tr><tr><td>Discover Object List</td><td>Get</td><td>Works the same as the discover node however allows a set of URIs to specified (including <a href="../../user-guides/mobiusflow-r/mobiusflow-uniform-resource-identifiers.md#mobiusflowuniformresourceidentifiers-mobiusuriwildcards">wildcards</a>). Node outputs all discovered MobiusFlow entities as either individual messages or a single array packaged message.</td></tr></tbody></table>
...
<figure><img src="../../.gitbook/assets/image (11).png" alt=""><figcaption><p>Example flow using setResource node to set resource with URI 000001/027/0201/0001/40</p></figcaption></figure>
