...
To add a service, first click on the Show Library button to show the list of available services, find the service you want to add, and click on the Add button for that service.
